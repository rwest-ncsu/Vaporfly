...
Proposing the following adjustment to model 5 for the most compicated model fit. I will keep the notation of $C_2, C_3$ to denote that this is a subset of a model previously attempted: 
