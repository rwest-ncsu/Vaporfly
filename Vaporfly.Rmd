...
Clearly, all of the $\alpha$ effects behave similarly and produced relatively similar estimates and Posterior Distributions. Because of this and the low effective sample size of the $\beta_0$ in this model, I propose the removal of the Marathon effect term in the model. 
